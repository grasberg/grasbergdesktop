...
~/.grasberg/AGENTS.md, the repo-root AGENTS.md, plus any AGENTS.md or
AGENTS.local.md in a directory that is an ancestor of a changed file (a
...
The finder angles: A line-by-line diff scan, B removed-behavior auditor, C cross-file tracer, D language-pitfall specialist (xhigh/max only), E wrapper/proxy correctness (xhigh/max only), plus Reuse, Simplification, Efficiency, Altitude, and Conventions (AGENTS.md violations).
...
## Appendix: code-review/medium.md
...
## Appendix: code-review/report-findings-tool.md
