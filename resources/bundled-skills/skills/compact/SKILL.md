---
name: compact
description: Produce a detailed structured summary of the conversation so far (context compaction / handoff). Text only, no tool calls; outputs an analysis block followed by a summary block.
---
